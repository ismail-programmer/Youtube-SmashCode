...
console.log(
  "nested Person object Mobile second name is " +
    person["Mobile Phone"]["Mobile second"]
);
...
console.log(
  "normal array before unshift " +
    fruits +
    " and our first fruit is " +
    fruits[0]
);
fruits.unshift("Water Melon");
console.log(
  "modify array after unshift " +
    fruits +
    " and our first fruit is " +
    fruits[0]
);
...
console.log(
  "min num " + points[0] + " and max number " + points[points.length - 1]
);
...
let subtract4 = (input1, input2) => {
  ...
  console.log(
    "this is local function variable witin the function " + result456
  );
...
console.log(
  "Number of even numbers in the array are ",
  countEvenNumber(numbers3)
);
...
//replace method
let text3 =
  "This is a youtube vdeo of Smash Code, vdeo and its a javascript vdeo.";
// with case senstive
